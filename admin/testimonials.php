...
$all_testimonials = $testimonials_stmt->fetchAll(PDO::FETCH_ASSOC);

$page_title = "Kelola Testimoni - Admin";
?>
<!DOCTYPE html>
<html lang="id">
<head>
        ...
        <nav class="navbar-top">
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center w-100">
                    <h5 class="mb-0">Kelola Testimoni</h5>
        ...
        <div class="content-area">
            ...
            <div class="table-card">
                <div class="table-card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0"><i class="fas fa-comments me-2"></i>Daftar Testimoni</h5>
                    <div>
                        <a href="testimonials_add.php" class="btn btn-primary btn-sm">
                        ...
                        <tbody>
                            <?php if (count($all_testimonials) > 0): ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge <?php echo $testimonial['is_approved'] ? 'bg-success' : 'bg-warning'; ?>">
                                    ...
                                    <td>
                                        <div class="action-buttons">
                                            <?php if (!$testimonial['is_approved']): ?>
                                                <a href="testimonials_approve.php?id=<?php echo $testimonial['id']; ?>" 
                                                   class="btn btn-success btn-sm" 
                                                   title="Approve"
                                                   onclick="return confirm('Approve testimoni dari <?php echo htmlspecialchars(addslashes($testimonial['name'])); ?>?')">
                                                    <i class="fas fa-check"></i>
                                                </a>
                                            <?php else: ?>
                                                <a href="testimonials_unapprove.php?id=<?php echo $testimonial['id']; ?>" 
                                                   class="btn btn-warning btn-sm" 
                                                   title="Unapprove"
                                                   onclick="return confirm('Batalkan persetujuan testimoni dari <?php echo htmlspecialchars(addslashes($testimonial['name'])); ?>?')">
                                                    <i class="fas fa-times"></i>
                                                </a>
                                            <?php endif; ?>
                                            <a href="testimonials_edit.php?id=<?php echo $testimonial['id']; ?>" 
                                               class="btn btn-primary btn-sm" 
                                               title="Edit">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <form action="testimonials_delete.php" method="POST" class="d-inline">
                                                <input type="hidden" name="id" value="<?php echo $testimonial['id']; ?>">
                                                <button type="submit" 
                                                        class="btn btn-danger btn-sm" 
                                                        title="Hapus"
                                                        onclick="return confirm('Hapus testimoni dari <?php echo htmlspecialchars(addslashes($testimonial['name'])); ?>? Tindakan ini tidak dapat dibatalkan!')">
